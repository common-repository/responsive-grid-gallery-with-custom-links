(function( $ ) {
    ...
    $(function() {
        ...
        var vTabsMgr_1 = $( abcfrggcl_VTabs.mgr_1).children( '.abcflVTabsNavCntr' ), tabIndex1 = null;
        var vTabsCntCntr_1 = abcfrggcl_VTabs.cntCntr_1;
        var vTabsMgr_2 = $( abcfrggcl_VTabs.mgr_2).children( '.abcflVTabsNavCntr' ), tabIndex1 = null;
        var vTabsCntCntr_2 = abcfrggcl_VTabs.cntCntr_2;
    ...
    vTabsMgr_1.children().each(function() {
        $( this ).on( 'click', function( evt ) {
            ...
            if ( ! $( this ).hasClass( 'abcflVTabsTabActive' ) ) {
                ...
                $( '.abcflVTabsTabActive', abcfrggcl_VTabs.mgr_1 ).removeClass( 'abcflVTabsTabActive' );
                ...
                $( vTabsCntCntr_1 )
                 ...
                 //console.log($( abcfrggcl_VTabs.mgr_1 ).children());
    ...
    vTabsMgr_2.children().each(function() {
        $( this ).on( 'click', function( evt ) {
            ...
            if ( ! $( this ).hasClass( 'abcflVTabsTabActive' ) ) {
                ...
                // Unmark the current tab and mark the new one as active
                $( '.abcflVTabsTabActive', abcfrggcl_VTabs.mgr_2 ).removeClass( 'abcflVTabsTabActive' );
                $( this ).addClass( 'abcflVTabsTabActive' );
